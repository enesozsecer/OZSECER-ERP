...
export function goTo(view) {
  ...
  const titles = { home: 'Ana Sayfa', cari: 'Cari Hesaplar', urun: 'Ürünler', sip: 'Siparişler', kasa: 'Kasa', analiz: 'Analiz', ayarlar: 'Sistem Yönetimi', publish: 'Yayın', katalog: 'Katalog', 'cloud-settings': 'Bulut Bağlantı' };
